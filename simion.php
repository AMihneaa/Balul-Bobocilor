...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Simion Valentin</title>
...
<div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: -3.6rem;">
                        <h2>Simion Valentin</h2>
                        <div class="tours__text__widget">

                        </div>
                        <div class="tours__text__desc">
                            <p>Pentru că niciun vis nu este imposibil de atins, Vali este un idealist convins.</p>
                            <p> Îi place să aibă o viață activă, pasiunile sale principale fiind sportul, festivalurile, călătoriile exotice, muzica și dansul.</p>
                        </div>
                   <?php 
    ...
    {    
      ...
      echo ' <form action="votare_baieti.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Simion Valentin" class="primary-btn border-btn"> Votează  </button>
                        </form>';
                ...
                <div class="col-lg-6 order-lg-3">
                    <div class="tours__item__pic tours__item__pic--left">
                        <img src="img/events/baiat5.webp" alt="">
                    </div>
                </div>
