...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Soare Cristina-Gabriela</title>
...
<div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: 9rem;">
                        <h2>Soare Cristina-Gabriela</h2>
                        <div class="tours__text__widget">

                        </div>
                        <div class="tours__text__desc">
                            <p>Hotărâtă din fire și foarte ambițioasă, Cristina dă mereu ce are mai bun pentru a reuși. </p>
                            <p>Îi place să îi ajute pe cei din jurul său și să se încarce cu energia lor pozitivă, fiind un bun ascultător și o persoană înțelegătoare.</p>
                        </div>
                        <?php 
    ...
    {    
      ...
      echo ' <form action="votare.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Soare Cristina-Gabriela" class="primary-btn border-btn"> Votează  </button>
                        </form>';
        
    }
    else echo' <form action="" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="" class="primary-btn border-btn"> Ai votat! </button>
                        </form>';
                ...
                <div class="col-lg-6 order-lg-3">
                    <div class="tours__item__pic tours__item__pic--left">
                        <img src="img/events/fata1.webp" alt="">
                    </div>
                </div>
...
<!-- Footer Section Begin --> <!-- Countdown Section Begin -->
