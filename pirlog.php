...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Pîrlog Andrei Cristian</title>
...
<div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: 9rem;">
                        <h2>Pîrlog Andrei Cristian</h2>
                        <div class="tours__text__widget">

                        </div>
                        <div class="tours__text__desc">
                            <p>O persoană dinamică și idealistă, Andrei este mereu în căutare de experiențe noi.</p>
                            <p> Pasionat de dans și sport, Andrei consideră că trăsătura care îl definește este ambiția. </p>

                            <p> Este de părere că se remarcă prin carismă, atitudine, dar și prin mișcările sale spectaculoase. </p>
                        </div>
                     <?php 
    ...
    {    
      ...
      echo ' <form action="votare_baieti.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Pirlog Andrei Cristian" class="primary-btn border-btn"> Votează  </button>
                        </form>';
                ...
                <div class="col-lg-6 order-lg-3">
                    <div class="tours__item__pic tours__item__pic--left">
                        <img src="img/events/baiat6.webp" alt="">
                    </div>
                </div>
