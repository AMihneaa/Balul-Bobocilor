...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Cucoaneș Georgiana</title>
...
<div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: 9rem;">
                        <h2>Cucoaneș Georgiana</h2>
                        <div class="tours__text__widget">

                        </div>
                        <div class="tours__text__desc">
                            <p>Georgiana se consideră o fire energică, ambițioasă, puternică, dar și sensibilă totodată.</p>
                            <p>Perseverența și seriozitatea sunt elemente care o însoțesc permanent în viața personală, făcând din ea un om motivat și plin de speranță.</p>
                        </div>
                        <?php 
    ...
    {    
      ...
      echo ' <form action="votare.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Cucoanes Georgiana" class="primary-btn border-btn"> Votează  </button>
                        </form>';
                ...
                <div class="col-lg-6 order-lg-3">
                    <div class="tours__item__pic tours__item__pic--left">
                        <img src="img/events/fata6.webp" alt="">
                    </div>
                </div>
