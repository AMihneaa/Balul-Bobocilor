...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Sandu Diana Ioana</title>
...
<div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: 9rem;">
                        <h2>Sandu Diana Ioana</h2>
                        <div class="tours__text__widget">

                        </div>
                        <div class="tours__text__desc">
                            <p>Ioanei îi plac moda şi muzica, fiind o fire creativă, empatică și spontană. </p>
                            <p> Curajoasă și plină de energie, ea este mereu pregătită să își întreacă limitele. Pasiunile ei, dansul și gimnastica, îi oferă libertate în exprimarea sentimentelor.</p>
                        </div>
                   <?php 
    ...
    {    
      ...
      echo ' <form action="votare.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Sandu Diana Ioana" class="primary-btn border-btn"> Votează  </button>
                        </form>';
                ...
                <div class="col-lg-6 order-lg-3">
                    <div class="tours__item__pic tours__item__pic--left">
                        <img src="img/events/fata2.webp" alt="">
                    </div>
                </div>
...
<!-- Tours Section End --> <!-- Countdown Section Begin -->
