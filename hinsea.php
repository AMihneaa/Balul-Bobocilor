...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Hînșea Mihai</title>
...
<div>
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: 9rem;">
                        ...
                        <div class="tours__text__desc">
                            <p>Mihai se consideră o persoană amuzantă, deși prietenii săi nu au confirmat acest aspect.  </p>
                            <p>Poate fi însă și serios, atunci cand e cazul, încrederea în propriile forțe și dorința de a se autodepăși fiind unele dintre atributele sale dominante.</p>
                        </div>
                <?php 
    ...
    {    
      ...
      echo ' <form action="votare_baieti.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Hinsea Mihai" class="primary-btn border-btn"> Votează  </button>
                        </form>';
                ...
                <div class="col-lg-6 order-lg-3">
                    <div class="tours__item__pic tours__item__pic--left">
                        <img src="img/events/baiat4.webp" alt="">
                    </div>
                </div>
