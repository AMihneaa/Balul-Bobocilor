...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Popa Ioana-Diana</title>
...
<div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: 9rem;">
                        <h2>Popa Ioana-Diana</h2>
                        <div class="tours__text__widget">

                        </div>
                        <div class="tours__text__desc">
                            <p>Fiind o fire extrovertă, sociabilă și foarte activă, atât pe rețelele de socializare , cât și în viața reală, Ioana iubește să se afle în compania oamenilor și să le aducă mereu zâmbetul pe buze.  </p>
                            <p> Fiind îndrăzneață, energică și ambițioasă, este pregătită de orice provocare și adoră să iasă din zona de confort.</p>
                        </div>
                          <?php 
    ...
    {    
      ...
      echo ' <form action="votare.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Popa Ioana-Diana" class="primary-btn border-btn"> Votează  </button>
                        </form>';
