...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Roșu Vlad Florin</title>
...
<div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: 9rem;">
                        <h2>Roșu Vlad Florin</h2>
                        <div class="tours__text__widget">

                        </div>
                        <div class="tours__text__desc">
                            <p>Vlad este o persoană ambițioasă, talentată, plină de viață, creativă și pasionată de artă. </p>
                            <p>Iubește lucrul manual, dansul și muzica, este o fire sociabilă și un pasionat al voluntariatului.</p>
                        </div>
        <?php 
    ...
    {    
      ...
      echo ' <form action="votare_baieti.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Rosu Vlad Florin" class="primary-btn border-btn"> Votează  </button>
                        </form>';
