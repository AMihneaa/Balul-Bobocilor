...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Paraschiv Irina</title>
...
<div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: 9rem;">
                        <h2>Paraschiv Irina</h2>
                        <div class="tours__text__widget">

                        </div>
                        <div class="tours__text__desc">
                            <p>Pasionată de sport de mică, Irina este practicantă de arte marțiale, având în portofoliu nenumărate titluri. </p>
                            <p> Este mereu dornică să încerce lucruri noi ce îi pun aptitudinile la încercare, fiind muncitoare și ambițioasă.</p>
                        </div>
                          <?php 
    ...
    {    
      ...
      echo ' <form action="votare.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Paraschiv Irina" class="primary-btn border-btn"> Votează  </button>
                        </form>';
                ...
                <div class="col-lg-6 order-lg-3">
                    <div class="tours__item__pic tours__item__pic--left">
                        <img src="img/events/fata3.webp" alt="">
                    </div>
                </div>
