...
<head>
    <meta charset="UTF-8">
    <title>BBETTI | Oteșanu Alexandra Maria</title>
...
?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-4">
                    <div class="tours__item__text tours__item__text--right" style="margin-top: 9rem;">
                        <h2>Oteșanu Alexandra Maria</h2>
                        <div class="tours__text__widget">

                        </div>
                        <div class="tours__text__desc">
                            <p>Alexandra este o persoană caldă, sociabilă, iubitoare și plină de viață.</p>
                            <p>Fiind ambițioasă, acceptă orice provocare, ghidându-se după premisa ”totul sau nimic”</p>
                        </div>
                          <?php 
    ...
    {    
      ...
      echo ' <form action="votare.php" method="post" class = "text">
                            <button type="submit" name="numeconcurent" value="Oteseanu Alexandra Maria" class="primary-btn border-btn"> Votează  </button>
                        </form>';
                ...
                <div class="col-lg-6 order-lg-3">
                    <div class="tours__item__pic tours__item__pic--left">
                        <img src="img/events/fata5.webp" alt="">
                    </div>
                </div>
